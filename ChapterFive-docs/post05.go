...
// The Userdata structure is for holding full user data // from the Userdata table and the Username from the
// Users table
...
// The function returns the User ID of the username // -1 if the user does not exist
